...
// current employee work details
// SELECT  U.user_name, U.user_role,  A.work_details FROM attendance AS A JOIN users AS U ON U.id = A.user_id WHERE DATE(A.create_at) = DATE(CURRENT_DATE)
